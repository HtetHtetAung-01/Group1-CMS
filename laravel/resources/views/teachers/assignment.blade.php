                                                ...
                                                <tbody>
                                                    @foreach ($course->assignmentList as $item)
                                                        <tr class="tr-record">
                                                            ...
                                                            <td class="file-path">
                                                                <a
                                                                    href="{{ route('teacher.assignment.download', ['id' => 3, 'assignment_id' => $item->id]) }}">
                                                            ...
                                                            <td>
                                                                <button class="open-button"
                                                                    onclick="openForm('{{ route('teacher.assignment.grade.submit', ['id' => 4, 'assignment_id' => $item->id]) }}')">Submit
                                                                    Grade</button>
                                                            </td>
                                                        </tr>
                                                        <tr>
