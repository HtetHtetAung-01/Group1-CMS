    ...
    <div class="admin-container">
        <div class="admin-nav">
            ...
            <div class="tab clearfix">
                <button class="tab-btn active" onclick="showList(event,'user')">All Users <br> <span
                        class="count">{{ $userCount }} users</span></button>
                <button class="tab-btn" onclick="showList(event,'teacher')">Teachers <br> <span
                        class="count">{{ $teacherCount }} teachers</span></button>
                <button class="tab-btn" onclick="showList(event,'student')">Students <br> <span
                        class="count">{{ $studentCount }} students</span></button>
                <button class="tab-btn" onclick="showList(event,'course')">Courses <br> <span
                        class="count">{{ $courseCount }} courses</button>
                <button class="tab-btn" onclick="showList(event,'assignment')">Assignments <br> <span
                        class="count">{{ $assignmentCount }} assignments</button>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($teacherList as $teacher)
                            <tr class="row">
                                <td class="number">{{ ++$index }}</td>
                                <td><a type="button"
                                        href="{{ route('enroll.teacher', ['teacher_id' => $teacher->id]) }}"
                                        data-modal="modal-enroll" class="btn-show-modal enroll-btn">Enroll</a></td>
                                <td>{{ $teacher->id }}</td>
                                <td>{{ $teacher->name }}</td>
                            ...
                            <tr class="row">
                                ...
                                <td>
                                    <a href="{{ route('assignment.add', ['assignment_id' => $course->id]) }}"
                                        class="add-assignment-btn btn-padding">Add</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
