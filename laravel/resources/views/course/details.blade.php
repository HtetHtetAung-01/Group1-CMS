    ...
    <div class="assignment-list">
        <dl class="accd-lists">
            ...
            <div class="accd-li course">
                ...
                <dd class="accd-dd" style="{{Request::get('active') ==  $courseDetails[$key]->id ? 'display:block' : ''}}">
                                ...
                                <div class="homework d-flex">
                                    ...
                                    <div class="disabled-input">
                                        ...
                                        <div class="{{ $isEnrolled ? 'disabled-input' : 'upload-hw' }}">
                                            ...
                                            {{ csrf_field() }}
                                            @if ($started[$key] == false || $assignmentStatus[$key] == 'completed')
                                            <input type="file" name="inputFile" class="default-file-input disabled-file-input" disabled />
                                            @else
